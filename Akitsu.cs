...
namespace AkitsuApp {
    class Program {
        ...
        static void Main() {
            ...
            int desiredWidth = 1340;
            int desiredHeight = 1040;
            string profileDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AkitsuWebApp_Profile");
